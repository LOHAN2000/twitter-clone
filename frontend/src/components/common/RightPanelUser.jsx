...
export const RightPanelUser = ({user, type}) => {
  ...
  return (
    <div className={`flex ${type === 'profile' ? 'flex-row items-center' : type === 'search' ? 'flex-row items-center' : 'sm:flex-col lg:flex-row items-start'} hover:bg-[rgb(231,233,234,0.1)] px-3 py-2`}>
